...
class TitleNameAdapter_20220613(val titlenameList: ArrayList<TitleName>) : RecyclerView.Adapter<TitleNameAdapter.CustomViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TitleNameAdapter.CustomViewHolder {
        ...
        /* 퀴즈버튼 클릭하면 */
        val btnImage = view.findViewById<ImageButton>(R.id.imgbtn_question)
